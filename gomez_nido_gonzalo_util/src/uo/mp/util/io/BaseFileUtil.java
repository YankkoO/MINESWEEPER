...
public abstract class BaseFileUtil {
    ...
    public void writeLines(String fileName, List<String> lines) {
    	try {
    		BufferedWriter out = createBufferedWriter(fileName);
            try {
    ...
    protected abstract BufferedReader createBufferedReader(String filename) throws FileNotFoundException;
    protected abstract BufferedWriter createBufferedWriter(String filename) throws FileNotFoundException;
